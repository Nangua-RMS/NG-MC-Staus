...
本项目为二次开发，原作者信息在本页底部。本项目遵循原项目开源协议Apache 2.0，您可以在遵守协议的前提下自由使用、修改和分发本项目的代码。
为区分原有项目功能，本项目新增功能带有-NG标识。作者：良医☭南瓜   联系：2907613263@qq.com
## 功能特点
...
- **增加数据刷新**：每10s自动刷新一次服务器数据，可自主开关显示当前刷新状态（运行/暂停）-NG
- **增加人数变动高可看**：显示当前刷新对比上次数据的变动 -NG
- **服务器卡片优化**：修改原有项目的同步获取，改为异步优化网站访问速度 -NG
- **将外部JS库改为本地加载**：提高可靠性和访问速度（原1.3s优化到1.1s） -NG
### 管理功能
- 管理员后台管理界面
- 添加、编辑和删除服务器
- 设置服务器排序权重
...
- **Relief156**：二次开发，[原项目地址](https://github.com/Relief156/Minecraft-Server-Status/)
如有任何问题或建议，请联系开发者。
